...
export default async function DashboardPage() {
  ...
  const [received, diagnosing, repairing, ready, delivered, [latestLog]] = await Promise.all([
            ...
            {statusCounts.Received > 0 && (
              <div className="mt-6 flex items-start gap-2 rounded-lg border-l-4 border-brand-600 bg-slate-50 p-3 text-xs text-slate-600">
                ...
                <span>
                  ...
                  {statusCounts.Received !== 1 ? "s" : ""} waiting for diagnosis. Assign the oldest records first to
          ...
          <div className="flex flex-wrap items-center gap-5">
            ...
            <div className="min-w-[220px] flex-1">
              ...
              <p className="mt-0.5 text-sm text-slate-500">
                {activeRepairs} active repair{activeRepairs === 1 ? "" : "s"} in progress. {statusCounts.Ready} device
